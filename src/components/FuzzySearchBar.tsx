 ...
 */
export default function FuzzySearchBar({ products, onSearch }: FuzzySearchBarProps) {
                ...
                <div className="absolute top-full left-0 w-full mt-2 bg-white dark:bg-zinc-900 border border-black/5 dark:border-white/10 rounded-2xl shadow-2xl z-50 overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200">
                    {results.length > 0 ? (
                        ...
                        <div className="p-6 text-center space-y-2">
                            <p className="text-sm font-bold opacity-60 italic">No encontramos ese corte exacto...</p>
                            <p className="text-[10px] uppercase font-black text-primary">¡Intenta con "Res", "Cerdo" o "Premium"!</p>
                        </div>
                    )}
                </div>
            )}
